...
static const char *fonts[]          = { "FantasqueSansMono:size=10", "JoyPixels:pixelsize=10:antialias=true:autohint=true"  };
static char dmenufont[]             = "FantasqueSansMono:size=10";
...
const char *spcmd2[] = {"st", "-n", "spcalc", "-f", "InputMono:size=16", "-g", "50x20", "-e", "bc", "-lq", NULL };
...
static const Rule rules[] = {
	...
	*/
	...
	{ NULL,     NULL,       "ncmpcpp",       	    1 << 2,       0,           0,         0,        -1 },
	{ "Brave-browser",     NULL,       NULL,       	    1 << 0,       0,           0,         0,        -1 },
	{ "Steam",    NULL,       NULL,       	    1 << 4,       0,           0,         0,        -1 },
	{ "csgo_linux64",    NULL,       NULL,       	    1 << 5,       0,           0,         0,        -1 },
